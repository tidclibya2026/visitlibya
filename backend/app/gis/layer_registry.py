...
LAYER_REGISTRY: dict[str, GovernedGISLayer] = {
    ...
    for layer in (
        ...
        _layer(
            "OLD_CITIES", "المدن القديمة", "Old Cities",
            "old_city", GeometryFamily.MIXED,
            "Reserved for institutionally resolved old-city and historic urban-settlement features.",
        ),
        _layer(
        ...
        _layer(
            "PARKS", "المنتزهات", "Parks",
            "park", GeometryFamily.MIXED,
        ...
        _layer(
            "TOURISM_RESORTS", "القرى والمنتجعات السياحية", "Tourism Resorts",
            "tourism_resort", GeometryFamily.MIXED,
